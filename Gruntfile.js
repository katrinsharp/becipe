    ...
    grunt.initConfig({
        ...
        sass: {
            ...
            dist: {
				...
				{
					expand: true,
                    cwd: '<%= config.app %>/../bower_components/bootstrap-sass-official/vendor/assets/stylesheets',
                    src: ['*.scss'],
                    dest: '.tmp/styles',
                    ext: '.css'
				}]
        ...
        copy: {
            ...
            styles: {
                ...
                src: ['<%= config.app %>/styles/{,*/}*.css', 
					'external/icomoon/{,*/}*.css', 
					'external/flexslider/flexslider.css',
					'external/font-awesome/css/font-awesome.css',
					'external/bootstrap-editable/bootstrap-editable/css/bootstrap-editable.css', 
					'external/select2/select2.css', 
					'external/bootstrap-select/bootstrap-select.css',
					'external/footable2/css/footable.core.css',
					'external/bootstrap-fileupload/bootstrap-fileupload.css',
					'external/bootstrap-editable/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5-0.0.2.css']
            },
